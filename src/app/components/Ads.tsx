...
const Desktopads = () => {
  return (
    <div className=" px-8 mx-auto">
      <div className="mt-20 w-full mx-auto max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-3/4 max-md:ml-0 max-md:w-full">
            <div className="grow p-4 border-[2px] border-solid border-white border-opacity-10 max-md:pr-5 max-md:mt-5 max-md:max-w-full">
              <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                <div className="flex flex-col w-[37%] max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center  border-solid border-white border-opacity-10 max-md:mt-8">
                    <img
                      loading="lazy"
                ...
                <div className="flex flex-col ml-5 w-[63%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col self-stretch my-auto text-xs text-white max-md:mt-10">
                    <h1>
                      <div className="text-2xl">Alpha Mode</div>
                    </h1>
                    <div className="mt-4 text-white text-opacity-30">
                      Describe Alpha Mode as a selective, supportive pathway
                      offering comprehensive services to ensure project success.
                    </div>
                    <div className="flex gap-2 text-sm justify-center px-6 py-3 mt-5 font-bold border w-[50%] border-solid border-white border-opacity-10 max-md:px-5 bg-violet-600">
                      <a href="/visit">
                      ...
                      <img
                        ...
                        className="shrink-0 my-auto  border-white border-solid aspect-[2.86] stroke-[1px] stroke-white w-[31px]"
                        alt="Visit Site"
                      />
                    </div>
                  </div>
              ...
              <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                ...
                <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col self-stretch my-auto text-xs text-white max-md:mt-10">
                    <h1>
                      {" "}
                      <div className="text-2xl">Degan Mode</div>
                    </h1>
                    <div className="mt-4 text-white text-opacity-30">
                      Random project launched by team
                    </div>
                    <div className="flex gap-2 text-sm justify-center px-6 py-3 mt-8 w-[60%] font-bold border border-solid border-white border-opacity-10 max-md:px-5   bg-violet-600 ">
                      <a href="/visit">
